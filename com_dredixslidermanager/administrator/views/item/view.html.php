...
class DredixSliderManagerViewItem extends JView
{
	protected $form;
	protected $item;
	protected $state;
	...
	protected function addToolbar()
	{
		...
		$text = $isNew ? JText::_( 'COM_DREDIXSLIDERMANAGER_NEW' ) : JText::_( 'COM_DREDIXSLIDERMANAGER_EDIT' );
		JToolBarHelper::title(   JText::_( 'COM_DREDIXSLIDERMANAGER_ITEM' ).': <small><small>[ ' . $text.' ]</small></small>', 'generic.png' );
